...
try{
    ...
    let nishant =new Contact("Nishant","Kadam","Hanuman Nagar","Coimbtore","Telangana",401078,8930516201,"NishantKadam@gmail.com")
    addressBook1.push(prathmesh)
    addressBook1.push(pranit)   
    add(addressBook1,nishant)
    countByCity(addressBook1,"Coimbtore")
    countByState(addressBook1,"Telangana")
}catch(e){
    console.error(e)
}